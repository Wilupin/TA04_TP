...
Pour être plus rapide dans le code ces fonctions sont en réalité calculées à l'aide de la formule de récurrence suivante. Ceci esr pratique puisque nous avons besoin de toutes les fonctions de hankel jusuqu'à l'ordre $L$.
...
\begin{table}[H]
\centering
\begin{tabular}{m{0.5cm} m{0.5cm} | m{2cm} m{2cm} m{2cm} m{2cm} | m{2.5cm} m{2.5cm}} 
   \hline
    $k$ & $L_q$ & $\xv/L$ & $\yv/L$ & $\xv_0/L$ & $\yv_0/L$ & Res exact & Res approché \\
    \toprule
    \toprule
    $4\pi$ & 1 & (0 0 0) & (1 0.5 0.5) & (0 0 0) & (1.5 0.5 0.5) & 0 & 0\\
    $4\pi$ & 5 & (0 0 0) & (1 0.5 0.5) & (0 0 0) & (1.5 0.5 0.5) & 0 & 0\\ \hline
    $4\pi$ & 5 & (0.1 0.1 0.1) & (1.1 0.4 0.6) & (0 0 0) & (1.5 0.5 0.5) & 0 & 0\\
    $4\pi$ & 10 & (0.1 0.1 0.1) & (1.1 0.4 0.6) & (0 0 0) & (1.5 0.5 0.5) & 0 & 0\\ \hline
